    ...
    function Admin($cookie,$cookieKey){
        ...
        for($i=0;$i<$dayLeng;$i++) {
            ...
            foreach($serverS as $server ) {
                ...
                $sql = "select aa.Schrname,aa.sAccount from {$server['DBGameName']}.dbo.mir_hum_info as aa where dcreateDate >= '{$StartDayTableName_s}' and   dcreateDate < '{$StartDayTableName_e}' ";
                $user_result[$server['id']]=$dblink->query($sql);
            }
