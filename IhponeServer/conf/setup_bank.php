...
define("LIENSON_POST",2040);                                                               //访问之间通信端口
define("LIENSON_SPOST",'');                                                             //服务之间通信端口
define('WORKER_NUM',6);                                                                   //worker数量
define("TASK_WORKER_NUM",2);                                                             //Task进程数
define("LOGFILE","/root/log/PhoneServer.log");                                       //日志路劲
define("DAEMONIZE",true);                                                                //是否开启守护模式
...
define('DB_DATA','PhoneServer');                                                        //数据库名
