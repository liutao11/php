        ...
        if($pregResult) {                                                                   //图片请求
            ...
            if ($urllen == 1 || $urllen == 0) {
                ...
                if ($object_string) {
                    ...
                    if (is_file($fileurl)) {
                        $wk_object = new $object_name($this->webserver,$request, $response, $this->homeUrl, $this->my_friends, $this->tables, $this->read_db, $this->update_db, $this->rd,$this->main);
                        $wk_object->start();
                    } else {
