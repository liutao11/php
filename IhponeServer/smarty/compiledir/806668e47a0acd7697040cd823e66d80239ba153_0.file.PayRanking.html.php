<?php /* Smarty version 3.1.28-dev/54, created on 2016-06-24 16:29:29
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/PayRanking.html" */ ?>
<?php
/*%%SmartyHeaderCode:136927644576cef69cab5e8_07181665%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_576cef69df9963_09326350',
  'file_dependency' => 
  array (
    '806668e47a0acd7697040cd823e66d80239ba153' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/PayRanking.html',
      1 => 1466671546,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_576cef69df9963_09326350')) {
function content_576cef69df9963_09326350 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '136927644576cef69cab5e8_07181665';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1531865131576cef69d87575_05401473', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_576cef69d94d39_31938730', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_576cef69d94d39_31938730')) {
function content_576cef69d94d39_31938730 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '136927644576cef69cab5e8_07181665';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1978003552576cef69de6da8_71987883', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:136927644576cef69cab5e8_07181665%%*/
}
}
?><?php
/* block_function_bbb_1531865131576cef69d87575_05401473  file:Data/PayRanking.html */
if (!function_exists('block_function_bbb_1531865131576cef69d87575_05401473')) {
function block_function_bbb_1531865131576cef69d87575_05401473($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
                <tr class="ReportDataCenter">
                    <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['rowNum'];?>
</td>
                    <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['GameServerUnid'];?>
</td>
                    <td class="ReportDataCenter_list"  style="width: 240px;"><?php echo $_smarty_tpl->tpl_vars['vv']->value['UserID'];?>
</td>
                    <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['nNumberSum'];?>
</td>
                    <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['dCreateDate_cl'];?>
</td>
                    <td class="ReportDataCenter_list"><?php if ($_smarty_tpl->tpl_vars['vv']->value['daySum'] == 1) {?>今天<?php } else {
echo $_smarty_tpl->tpl_vars['vv']->value['daySum'];?>
天前<?php }?></td>
                </tr>
            <?php
...
>
    $(function(){
        var showPage=1;
        var classname='<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
';
...
/*/ block_function_bbb_1531865131576cef69d87575_05401473 */
?>
<?php
/* block_function_bbb_1978003552576cef69de6da8_71987883  file:Admin/index.html */
if (!function_exists('block_function_bbb_1978003552576cef69de6da8_71987883')) {
function block_function_bbb_1978003552576cef69de6da8_71987883($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_1978003552576cef69de6da8_71987883 */
?>
