<?php /* Smarty version 3.1.28-dev/54, created on 2016-07-28 17:06:11
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Operators/SendPropObjectEmil.html" */ ?>
<?php
/*%%SmartyHeaderCode:2025911075799cb03145575_12744902%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5799cb03261b33_01081726',
  'file_dependency' => 
  array (
    '6f1e3fb7a227cbfcea203ca15edff8a7953a9bce' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Operators/SendPropObjectEmil.html',
      1 => 1466079502,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5799cb03261b33_01081726')) {
function content_5799cb03261b33_01081726 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '2025911075799cb03145575_12744902';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_17198483025799cb031d5c29_10435300', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5799cb031eeda7_35799473', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_5799cb031eeda7_35799473')) {
function content_5799cb031eeda7_35799473 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '2025911075799cb03145575_12744902';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_13662217225799cb03248c21_09125455', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:2025911075799cb03145575_12744902%%*/
}
}
?><?php
/* block_function_bbb_17198483025799cb031d5c29_10435300  file:Operators/SendPropObjectEmil.html */
if (!function_exists('block_function_bbb_17198483025799cb031d5c29_10435300')) {
function block_function_bbb_17198483025799cb031d5c29_10435300($_smarty_tpl, $block) {?>
<style>
    ...
    .showList textarea{line-height: 30px;height: 90px;display: block;float: left;width: 700px;border: 1px solid #cccccc}
    ...
    .row_message{background: #DEDEDE;color:  #438EB9;height: 20px;}
...
</span> 平台->运维->范围道具邮件发送</div>
<div style="padding-top: 10px;">
    <div class="ReportData">
        <div class="container_tt"><div class="iconC1"></div>范围道具邮件发送</div>
...
" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['GameServerUnid'];?>
</div>
                <?php
$_smarty_tpl->tpl_vars['vv'] = $__foreach_vv_0_saved_local_item;
}
...
?>
        ...
        <div class="showList">
            ...
            <div class="showList_message" style="width: 1000px;"><span>无</span></div>
        </div>
        ...
        <div style="background:  #DEDEDE;display: none">
            <div style="" class="row_message">*不填表示没有限制</div>
            <div class="showList" >
                <div class="showList_name">角色等级*：</div>
                <span style="text-align: center">从</span>
                <input type="text" name="levelStarte" style="width: 60px;"  class="levelStarte">
                <span style="text-align: center">到</span>
                <input type="text" name="levelEnd" style="width: 60px;"  class="levelEnd">
            </div>

            <div class="showList" >
                <div class="showList_name">角色职业*：</div>
                <input type="radio" name="roleType" style="width: 10px;" value="-1" class="roleClass" checked>
                <span>不限制</span>
                <input type="radio" name="roleType" style="width: 10px;" value="0" class="roleClass" >
                <span>战士</span>
                <input type="radio" name="roleType" style="width: 10px;" value="1" class="roleClass" >
                <span>法师</span>
                <input type="radio" name="roleType" style="width: 10px;" value="2" class="roleClass" >
                <span>道士</span>
            </div>

            <div class="showList" >
                <div class="showList_name">登入时间段*：</div>
                <span style="text-align: center">从</span>
                <input type="text" class="loginStarteTime" name="loginStarteTime">

                <span style="text-align: center">到</span>
                <input type="text" class="loginEndTime" name="loginEndTime">
            </div>
            <div style="" class="row_message"></div>
        </div>
        <div class="showList">
...
>
    ...
    $(function(){
        ...
        $('.loginStarteTime').datetimepicker({
            lang:"ch",           //语言选择中文
            format:"Y-m-d H:00:00",      //格式化日期
            timepicker:true,    //关闭时间选项
            yearStart:2000,     //设置最小年份
        ...
        $(".serverIndex").change(function(){
            var serverId=$(this).val();
            if(serverId) {
                $.get("/SendPropEmilGet_Buffer/", {"doing": "serverIdAdd", "serverId": serverId,'doingunid':new Date().getTime()}, function (data) {
                    var obj = jQuery.parseJSON(data);
                    if (obj.status == 2000) {
                        var dataLeng=0;
                        var showString="";
        ...
        $(".userTest").click(function(){
            ...
            if(roleS){
                ...
                $.get("/SendPropEmilGet_Buffer/",{"doing": "roleSTest", "roleS": roleS},function(data){
                    var obj = jQuery.parseJSON(data);
                    if (obj.status == 2000) {
        ...
        $(".showList_submit").click(function(){
             if(showList_submit_status==1) {
                     ...
                     var levelStarte = $(".levelStarte").val();
                     var levelEnd = $(".levelEnd").val();
                     var roleType = $("input[name='roleType']:checked").val();
                     var loginStarteTime=$(".loginStarteTime").val();
                     var loginEndTime=$('.loginEndTime').val();
                     ...
                     if (isSetupTime && title && textarea && userObject) {
                         $(this).html('发送中...');
                         $(this).css({"background": "#616161"});
                         $.get("/SendObjectPropEmilGet/", {"userObject":userObject,"levelStarte":levelStarte,"levelEnd":levelEnd,"roleType":roleType,"loginStarteTime":loginStarteTime,"loginEndTime":loginEndTime,"isSetupTime": isSetupTime,"setupTime": setupTime,"title": title,"textarea":textarea,'doingunid':new Date().getTime()}, function (data) {
                             var obj = jQuery.parseJSON(data);
                             if (obj.status != 2000) {
                                 alert(obj.message);
                             } else {
    ...
    function addPropListSelect(id,title){
        $.get("/SendPropEmilGet_Buffer/",{"doing": "AddPropDefault",'PropId':id,'PropNum':'1',"PropName":title,'doingunid':new Date().getTime()},function(data){
            ...
            if(obj.status==2000) {
                ...
                $(".showList_message").eq(1).html(showString);
                $(".addPropList_in").hide();
                $(".searchBut").hide();
                $(".addPropList_in_select").hide();
                addPropList_in_statues=1;
...
/*/ block_function_bbb_17198483025799cb031d5c29_10435300 */
?>
<?php
/* block_function_bbb_13662217225799cb03248c21_09125455  file:Admin/index.html */
if (!function_exists('block_function_bbb_13662217225799cb03248c21_09125455')) {
function block_function_bbb_13662217225799cb03248c21_09125455($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_13662217225799cb03248c21_09125455 */
?>
