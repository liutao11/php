<?php /* Smarty version 3.1.28-dev/54, created on 2016-08-03 11:50:53
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/LevelCount.html" */ ?>
<?php
/*%%SmartyHeaderCode:33346679657a16a1d0bedc1_07645459%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_57a16a1d2dae20_38604405',
  'file_dependency' => 
  array (
    '7db1336ef074bbbd3e3ac9a833f149be27d05b54' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/LevelCount.html',
      1 => 1466648559,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57a16a1d2dae20_38604405')) {
function content_57a16a1d2dae20_38604405 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '33346679657a16a1d0bedc1_07645459';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_99014717157a16a1d24abd8_59665114', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_57a16a1d27cfa2_21958846', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_57a16a1d27cfa2_21958846')) {
function content_57a16a1d27cfa2_21958846 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '33346679657a16a1d0bedc1_07645459';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_25420045757a16a1d2c91e1_38190219', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:33346679657a16a1d0bedc1_07645459%%*/
}
}
?><?php
/* block_function_bbb_99014717157a16a1d24abd8_59665114  file:Data/LevelCount.html */
if (!function_exists('block_function_bbb_99014717157a16a1d24abd8_59665114')) {
function block_function_bbb_99014717157a16a1d24abd8_59665114($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
        ...
        <div class ="downloadExl" data_json='<?php echo $_smarty_tpl->tpl_vars['exportData']->value;?>
'>下载</div>
        <?php }?>
    </div>
...
%</td>
                ...
                <td class="ReportDataCenter_list"><a class="button_s" href="/LevelCountShowList/?levelNum=<?php echo $_smarty_tpl->tpl_vars['vv']->value['levelNum'];?>
...
';
    $(function() {
        ...
        $(".ReportDataTitle_list:eq(2)").click(function(){
            $.get("/LevelCountSort/",{'type':"1"},function(data){
                var obj = jQuery.parseJSON(data);
                if (obj.status != 2000) {
                    alert(obj.message)
                }
        ...
        $(".ReportDataTitle_list:eq(4)").click(function(){
            $.get("/LevelCountSort/",{'type':"2"},function(data){
                var obj = jQuery.parseJSON(data);
                if (obj.status != 2000) {
                    alert(obj.message)
                }
        ...
        $(".downloadExl").click(function(){
            ...
            $.post("/downloadExlPost/",{"dataJson":dataJson},function(data){
                var obj = jQuery.parseJSON(data);
                if (obj.status = 2000) {
        ...
        $(".ReportDataTitle_list_show_str").each(function(index){
            $(this).click(function(){
                ...
                $.get("/LevelCountAjax/",{"valueIndex":valueIndex},function(data){
...
/*/ block_function_bbb_99014717157a16a1d24abd8_59665114 */
?>
<?php
/* block_function_bbb_25420045757a16a1d2c91e1_38190219  file:Admin/index.html */
if (!function_exists('block_function_bbb_25420045757a16a1d2c91e1_38190219')) {
function block_function_bbb_25420045757a16a1d2c91e1_38190219($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_25420045757a16a1d2c91e1_38190219 */
?>
