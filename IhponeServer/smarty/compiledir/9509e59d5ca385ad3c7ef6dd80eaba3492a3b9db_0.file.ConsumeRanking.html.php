<?php /* Smarty version 3.1.28-dev/54, created on 2016-06-24 16:29:39
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/ConsumeRanking.html" */ ?>
<?php
/*%%SmartyHeaderCode:1260808886576cef7312df79_49771941%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_576cef732062e0_19323737',
  'file_dependency' => 
  array (
    '9509e59d5ca385ad3c7ef6dd80eaba3492a3b9db' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/ConsumeRanking.html',
      1 => 1464763584,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_576cef732062e0_19323737')) {
function content_576cef732062e0_19323737 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '1260808886576cef7312df79_49771941';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_246878993576cef7318d4c1_08285540', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_576cef73194bd4_67343306', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_576cef73194bd4_67343306')) {
function content_576cef73194bd4_67343306 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '1260808886576cef7312df79_49771941';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1832248195576cef731ee4d9_84176994', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:1260808886576cef7312df79_49771941%%*/
}
}
?><?php
/* block_function_bbb_246878993576cef7318d4c1_08285540  file:Data/ConsumeRanking.html */
if (!function_exists('block_function_bbb_246878993576cef7318d4c1_08285540')) {
function block_function_bbb_246878993576cef7318d4c1_08285540($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
">
    ...
    <div class="ReportData">
        <div class="ReportDataTitle">
            <div class="ReportDataTitle_list">排名</div>
            <div class="ReportDataTitle_list">服区</div>
            <div class="ReportDataTitle_list">玩家名</div>
            <div class="ReportDataTitle_list">消费数</div>
        </div>
...
?>
                <div class="ReportDataCenter" >
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['kk']->value+1;?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['GameServerUnid'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['PlayerName'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['sum'];?>
</div>
                </div>
            <?php
...
>
    $(function(){
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(startDay){
                $.get("/ConsumeRankingGet/",{"serverIndex":serverIndex,"startDay":startDay},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
        ...
        $(".pageInt").each(function(){
            $(this).click(function(){
                ...
                $.get("/ConsumeRankingPageGet/",{"pageInt":pageInt},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status==2000){
                        window.location.reload();
                    }
...
/*/ block_function_bbb_246878993576cef7318d4c1_08285540 */
?>
<?php
/* block_function_bbb_1832248195576cef731ee4d9_84176994  file:Admin/index.html */
if (!function_exists('block_function_bbb_1832248195576cef731ee4d9_84176994')) {
function block_function_bbb_1832248195576cef731ee4d9_84176994($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_1832248195576cef731ee4d9_84176994 */
?>
