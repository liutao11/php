<?php /* Smarty version 3.1.28-dev/54, created on 2016-06-24 16:29:54
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/PayDayReport.html" */ ?>
<?php
/*%%SmartyHeaderCode:1507712435576cef823798f8_76317329%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_576cef824a0f09_62414481',
  'file_dependency' => 
  array (
    '018b4275e646a30d5d15abb6f0d0ee927acb48da' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/PayDayReport.html',
      1 => 1466473265,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_576cef824a0f09_62414481')) {
function content_576cef824a0f09_62414481 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '1507712435576cef823798f8_76317329';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_995015771576cef8242fb71_46738972', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_576cef8243c5a9_08551347', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_576cef8243c5a9_08551347')) {
function content_576cef8243c5a9_08551347 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '1507712435576cef823798f8_76317329';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1387744738576cef8248c9c4_98967094', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:1507712435576cef823798f8_76317329%%*/
}
}
?><?php
/* block_function_bbb_995015771576cef8242fb71_46738972  file:Data/PayDayReport.html */
if (!function_exists('block_function_bbb_995015771576cef8242fb71_46738972')) {
function block_function_bbb_995015771576cef8242fb71_46738972($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
<style>
    ...
    .ReportDataTitle_list{float: left;line-height: 40px;height: 40px;width: 120px;text-align: center;font-size: 14px;font-weight: 600}
    .ReportDataCenter{background:#F5F5F5;border-bottom:1px solid #DEDEDE;height: 30px;position: relative}
    .ReportDataCenter_list{float: left;line-height: 30px;height: 30px;width: 120px;text-align: center;font-size: 12px;}
    ...
    <div class="ReportData">
        <table class="ReportData_list">
            <tr class="ReportDataTitle">
                ...
                <td class="ReportDataTitle_list">登入玩家</td>
                <td class="ReportDataTitle_list">ARPU</td>
                <td class="ReportDataTitle_list">ARPPU</td>
                <td class="ReportDataTitle_list">付费率</td>
                <td class="ReportDataTitle_list">来源渠道分布</td>
            </tr>
...
?>
                    <tr class="ReportDataCenter">
                        ...
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['day'];?>
</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['payNumberSum']/$_smarty_tpl->tpl_vars['ExchangeRate']->value;?>
元<?php if ($_smarty_tpl->tpl_vars['vv']->value['type'] == 1) {?><span style="color: red">+<?php echo $_smarty_tpl->tpl_vars['vv']->value['lv'];?>
%</span><?php } elseif ($_smarty_tpl->tpl_vars['vv']->value['type'] == 2) {?><span style="color: green">-<?php echo $_smarty_tpl->tpl_vars['vv']->value['lv'];?>
%</span><?php } else {
}?></td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['payTimeSum'];?>
</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['payUserSum'];?>
</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['NewPayUserSum'];?>
</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['PlayerSum'];?>
</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['ARPU'];?>
元</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['ARPPU'];?>
元</td>
                        <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['PayLv'];?>
%</td>
                        <td class="ReportDataCenter_list"><div class="button_m">详细</div></td>
                        <td class="ReportDataTitle_list_show">
                            <?php
$_from = $_smarty_tpl->tpl_vars['vv']->value['fromIdm'];
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_fromXJ_2_saved_item = isset($_smarty_tpl->tpl_vars['fromXJ']) ? $_smarty_tpl->tpl_vars['fromXJ'] : false;
$_smarty_tpl->tpl_vars['fromXJ'] = new Smarty_Variable();
$__foreach_fromXJ_2_total = $_smarty_tpl->_count($_from);
if ($__foreach_fromXJ_2_total) {
foreach ($_from as $_smarty_tpl->tpl_vars['fromXJ']->value) {
$__foreach_fromXJ_2_saved_local_item = $_smarty_tpl->tpl_vars['fromXJ'];
?>
                               <div class="ReportDataTitle_list_show_list">
                                   <span><?php echo $_smarty_tpl->tpl_vars['fromXJ']->value['name'];?>
:</span>
                                   <span style="font-weight: 600"><?php echo $_smarty_tpl->tpl_vars['fromXJ']->value['amount'];?>
</span>
                                   <span>元;</span>
                               </div>
                            <?php
$_smarty_tpl->tpl_vars['fromXJ'] = $__foreach_fromXJ_2_saved_local_item;
}
}
if ($__foreach_fromXJ_2_saved_item) {
$_smarty_tpl->tpl_vars['fromXJ'] = $__foreach_fromXJ_2_saved_item;
}
?>
                        </td>
                    </tr>
...
元</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['payNumberSum'];?>
</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['payUserSumSum'];?>
</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['NewPayUserSumSum'];?>
</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['PlayerSumSum'];?>
</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['ARPUSUM'];?>
元</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['ARPPUSUM'];?>
元</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['data_sum']->value['PaylvSUM'];?>
</td>
                    <td class="ReportDataCenter_list"><div class="button_sm">详细</div></td>
                    <td class="ReportDataTitle_list_show_s">
                        <?php
$_from = $_smarty_tpl->tpl_vars['data_sum']->value['fromInfoSum'];
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_fromXJ_3_saved_item = isset($_smarty_tpl->tpl_vars['fromXJ']) ? $_smarty_tpl->tpl_vars['fromXJ'] : false;
$_smarty_tpl->tpl_vars['fromXJ'] = new Smarty_Variable();
$__foreach_fromXJ_3_total = $_smarty_tpl->_count($_from);
if ($__foreach_fromXJ_3_total) {
foreach ($_from as $_smarty_tpl->tpl_vars['fromXJ']->value) {
$__foreach_fromXJ_3_saved_local_item = $_smarty_tpl->tpl_vars['fromXJ'];
?>
                        <div class="ReportDataTitle_list_show_list">
                            <span><?php echo $_smarty_tpl->tpl_vars['fromXJ']->value['name'];?>
:</span>
                        ...
                        <?php
$_smarty_tpl->tpl_vars['fromXJ'] = $__foreach_fromXJ_3_saved_local_item;
}
}
if ($__foreach_fromXJ_3_saved_item) {
$_smarty_tpl->tpl_vars['fromXJ'] = $__foreach_fromXJ_3_saved_item;
}
?>
                    </td>
                <?php }?>
        ...
        <div class="ReportData_list">
            <div id="container_cen" style="height: 300px;">
    ...
    $(function(){
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(startDay && endDay){
                ...
                $.get("/DayReportGet/",{"serverIndex":serverIndex,"startDay":startDay,"endDay":endDay,"class":"PayDayReport"},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
...
>
   var myChart = echarts.init(document.getElementById('container_cen'));
    var option = {
        ...
        legend: {data:['充值金额','充值人数']},
        calculable : true,
        xAxis : {type : 'category',data : <?php echo $_smarty_tpl->tpl_vars['data_payDay']->value;?>
},
        yAxis : [{type : 'value'}],
        series : [
            {name:'充值金额', type:'bar', data:<?php echo $_smarty_tpl->tpl_vars['data_payNumberSum']->value;?>
},
            {name:'充值人数', type:'line', symbol: 'none',data:<?php echo $_smarty_tpl->tpl_vars['data_payUserSum']->value;?>
}
        ]
    };
...
/*/ block_function_bbb_995015771576cef8242fb71_46738972 */
?>
<?php
/* block_function_bbb_1387744738576cef8248c9c4_98967094  file:Admin/index.html */
if (!function_exists('block_function_bbb_1387744738576cef8248c9c4_98967094')) {
function block_function_bbb_1387744738576cef8248c9c4_98967094($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_1387744738576cef8248c9c4_98967094 */
?>
