<?php /* Smarty version 3.1.28-dev/54, created on 2016-06-24 16:53:30
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/PayTimeAnalysis.html" */ ?>
<?php
/*%%SmartyHeaderCode:206506348576cf50a807612_41895858%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_576cf50a8d7804_20759537',
  'file_dependency' => 
  array (
    'f3ffb75583bebd36da413cae3991e709e1419074' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/PayTimeAnalysis.html',
      1 => 1466758082,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_576cf50a8d7804_20759537')) {
function content_576cf50a8d7804_20759537 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '206506348576cf50a807612_41895858';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_915263217576cf50a86c4c3_92416762', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_576cf50a8773f5_25086170', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_576cf50a8773f5_25086170')) {
function content_576cf50a8773f5_25086170 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '206506348576cf50a807612_41895858';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_147305222576cf50a8c5576_74423424', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:206506348576cf50a807612_41895858%%*/
}
}
?><?php
/* block_function_bbb_915263217576cf50a86c4c3_92416762  file:Data/PayTimeAnalysis.html */
if (!function_exists('block_function_bbb_915263217576cf50a86c4c3_92416762')) {
function block_function_bbb_915263217576cf50a86c4c3_92416762($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
    ...
    <div class="ReportData">
        <table class="ReportData_list">
            <tr class="ReportDataTitle">
                ...
                <td class="ReportDataTitle_list">充值额度(元)</td>
                <td class="ReportDataTitle_list">人数</td>
                <td class="ReportDataTitle_list">人数占比</td>
                <td class="ReportDataTitle_list">金额占比</td>
            </tr>
...
?>
                    <tr class="ReportDataCenter">
                        ...
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['mountSum'];?>
</td>
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['userSum'];?>
</td>
                        <td class="ReportDataCenter_list" ><?php if ($_smarty_tpl->tpl_vars['userSum']->value) {
echo sprintf("%.4f",$_smarty_tpl->tpl_vars['vv']->value['userSum']/$_smarty_tpl->tpl_vars['userSum']->value)*100;?>
%<?php } else { ?>0%<?php }?></td>
                        <td class="ReportDataCenter_list" ><?php if ($_smarty_tpl->tpl_vars['mountSum']->value) {
echo sprintf("%.4f",$_smarty_tpl->tpl_vars['vv']->value['mountSum']/$_smarty_tpl->tpl_vars['mountSum']->value)*100;?>
%<?php } else { ?>0%<?php }?></td>
                    </tr>
                <?php
...
?>
            ...
            <tr class="ReportDataTitle">
                ...
                <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['mountSum']->value;?>
</td>
                <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['userSum']->value;?>
</td>
            </tr>
        </table>
    </div>
...
>
    $(function(){
        $(".selectDiv_submit").click(function() {
            ...
            if(serverIndex){
                $.get("/PayTimeAnalysisGet/",{"serverIndex":serverIndex},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
...
/*/ block_function_bbb_915263217576cf50a86c4c3_92416762 */
?>
<?php
/* block_function_bbb_147305222576cf50a8c5576_74423424  file:Admin/index.html */
if (!function_exists('block_function_bbb_147305222576cf50a8c5576_74423424')) {
function block_function_bbb_147305222576cf50a8c5576_74423424($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_147305222576cf50a8c5576_74423424 */
?>
