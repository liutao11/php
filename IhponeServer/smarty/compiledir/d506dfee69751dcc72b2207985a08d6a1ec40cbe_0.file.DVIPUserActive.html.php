<?php /* Smarty version 3.1.28-dev/54, created on 2016-07-28 19:53:48
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/DVIPUserActive.html" */ ?>
<?php
/*%%SmartyHeaderCode:4633342065799f24cbb6399_33861920%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5799f24cd31c72_78980565',
  'file_dependency' => 
  array (
    'd506dfee69751dcc72b2207985a08d6a1ec40cbe' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/DVIPUserActive.html',
      1 => 1469687536,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5799f24cd31c72_78980565')) {
function content_5799f24cd31c72_78980565 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '4633342065799f24cbb6399_33861920';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_19809829805799f24cc64008_46128287', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5799f24cc797d0_82891117', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_5799f24cc797d0_82891117')) {
function content_5799f24cc797d0_82891117 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '4633342065799f24cbb6399_33861920';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_20379975925799f24cd0b2f7_60794629', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:4633342065799f24cbb6399_33861920%%*/
}
}
?><?php
/* block_function_bbb_19809829805799f24cc64008_46128287  file:Data/DVIPUserActive.html */
if (!function_exists('block_function_bbb_19809829805799f24cc64008_46128287')) {
function block_function_bbb_19809829805799f24cc64008_46128287($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
<style>
    ...
    .ReportDataTitle_list_show{position: absolute;width: 1010px;height: 100px;background:#438EB9;left: 570px;top: 30px;line-height: 30px;color: #ffffff;z-index: 10;box-shadow: 0 4px 5px #438EB9;border-radius: 2px;display: none}
    ...
    <div class="ReportData">
        <table class="ReportData_list">
            <tr class="ReportDataTitle">
                <td class="ReportDataTitle_list">vip等级</td>
                <td class="ReportDataTitle_list">等级人数</td>
                <td class="ReportDataTitle_list">所占比例(%)</td>
                <td class="ReportDataTitle_list">流失人数</td>
...
?>
                    <tr class="ReportDataCenter" style="position: relative">
                        ...
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['LevelSumLv'];?>
%</td>
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['loseUserSum'];?>
</td>
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['loseUserSumLv'];?>
%</td>
                    </tr>
                <?php
...
?>
                <tr class="ReportDataTitle">
                    ...
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['VIpSum']->value;?>
</td>
                    <td class="ReportDataTitle_list"></td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['VIploseUserSum']->value;?>
</td>
                    <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['VIploseUserLv']->value;?>
%</td>
                </tr>
            <?php } else { ?>
...
";
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(serverIndex!=0 && serverIndex!='' && startDay!= '' && endDay!='') {
                ...
                $.get("/DTaskGroupSet/", {"serverIndex": serverIndex,'className':className,"startDay":startDay,"endDay":endDay}, function (data) {
                    var obj = jQuery.parseJSON(data);
                    if (obj.status != 2000) {
                        alert(obj.message)
                    }
...
/*/ block_function_bbb_19809829805799f24cc64008_46128287 */
?>
<?php
/* block_function_bbb_20379975925799f24cd0b2f7_60794629  file:Admin/index.html */
if (!function_exists('block_function_bbb_20379975925799f24cd0b2f7_60794629')) {
function block_function_bbb_20379975925799f24cd0b2f7_60794629($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_20379975925799f24cd0b2f7_60794629 */
?>
