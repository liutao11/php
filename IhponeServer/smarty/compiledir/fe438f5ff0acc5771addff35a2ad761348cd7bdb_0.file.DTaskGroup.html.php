<?php /* Smarty version 3.1.28-dev/54, created on 2016-07-28 19:36:45
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/DTaskGroup.html" */ ?>
<?php
/*%%SmartyHeaderCode:12407827015799ee4d995700_54144157%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5799ee4da91412_29640578',
  'file_dependency' => 
  array (
    'fe438f5ff0acc5771addff35a2ad761348cd7bdb' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/DTaskGroup.html',
      1 => 1469687168,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5799ee4da91412_29640578')) {
function content_5799ee4da91412_29640578 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '12407827015799ee4d995700_54144157';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_5171388305799ee4da1c6a6_59832920', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5799ee4da2c285_08350570', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_5799ee4da2c285_08350570')) {
function content_5799ee4da2c285_08350570 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '12407827015799ee4d995700_54144157';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_21075643825799ee4da7f4c3_83734409', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:12407827015799ee4d995700_54144157%%*/
}
}
?><?php
/* block_function_bbb_5171388305799ee4da1c6a6_59832920  file:Data/DTaskGroup.html */
if (!function_exists('block_function_bbb_5171388305799ee4da1c6a6_59832920')) {
function block_function_bbb_5171388305799ee4da1c6a6_59832920($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
                    <tr class="ReportDataCenter" style="position: relative">
                        ...
                        <td class="ReportDataCenter_list" ><?php if ($_smarty_tpl->tpl_vars['data_sum']->value) {
echo sprintf("%.4f",$_smarty_tpl->tpl_vars['vv']->value['sum']/$_smarty_tpl->tpl_vars['data_sum']->value)*100;
} else { ?>0<?php }?></td>
                        <td class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['loseUserSum'];?>
</td>
                        <td class="ReportDataCenter_list" ><?php if ($_smarty_tpl->tpl_vars['vv']->value['sum']) {
echo sprintf("%.4f",$_smarty_tpl->tpl_vars['vv']->value['loseUserSum']/$_smarty_tpl->tpl_vars['vv']->value['sum'])*100;
} else { ?>0<?php }?></td>
...
">详细</div></td>
                        <td class="ReportDataTitle_list_show">
                            <?php
$_from = $_smarty_tpl->tpl_vars['vv']->value['userLevel'];
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
等级:<span><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
个角色</span></span>
                            <?php
...
/*/ block_function_bbb_5171388305799ee4da1c6a6_59832920 */
?>
<?php
/* block_function_bbb_21075643825799ee4da7f4c3_83734409  file:Admin/index.html */
if (!function_exists('block_function_bbb_21075643825799ee4da7f4c3_83734409')) {
function block_function_bbb_21075643825799ee4da7f4c3_83734409($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_21075643825799ee4da7f4c3_83734409 */
?>
