<?php /* Smarty version 3.1.28-dev/54, created on 2016-06-24 15:49:10
         compiled from "/mnt/hgfs/linux/IhponeServer/views/Data/ActiveUsers.html" */ ?>
<?php
/*%%SmartyHeaderCode:1295088575576ce5f6ccd246_88968775%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_576ce5f6d5c759_79044679',
  'file_dependency' => 
  array (
    'dfa9c790ff42d748916366c3d13e98ca4d6f9021' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer/views/Data/ActiveUsers.html',
      1 => 1466754544,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_576ce5f6d5c759_79044679')) {
function content_576ce5f6d5c759_79044679 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '1295088575576ce5f6ccd246_88968775';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1176862608576ce5f6cfd457_97291167', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_576ce5f6d03da5_66509747', 'ba8622e0524d5bd58d6704a76aae2039b67917da');
...
if ($_valid && !is_callable('content_576ce5f6d03da5_66509747')) {
function content_576ce5f6d03da5_66509747 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '1295088575576ce5f6ccd246_88968775';
?>
...
<!--                        <div class="list_m_title"><div class='list_icon9'></div>封禁帐号</div>
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1346736862576ce5f6d4be54_32366594', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:1295088575576ce5f6ccd246_88968775%%*/
}
}
?><?php
/* block_function_bbb_1176862608576ce5f6cfd457_97291167  file:Data/ActiveUsers.html */
if (!function_exists('block_function_bbb_1176862608576ce5f6cfd457_97291167')) {
function block_function_bbb_1176862608576ce5f6cfd457_97291167($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
">
    ...
    <table class="ReportData">
        <tr class="ReportDataTitle">
            ...
            <td class="ReportDataTitle_list">新增账号数</td>
            <td class="ReportDataTitle_list">活跃人数</td>
            <td class="ReportDataTitle_list">用户总量</td>
            <td class="ReportDataTitle_list">活跃率</td>
            <td class="ReportDataTitle_list">当天充值人数</td>
            <td class="ReportDataTitle_list">当天充值率</td>
            <td class="ReportDataTitle_list">充值总人数</td>
            <td class="ReportDataTitle_list">总充值率</td>
        </tr>
...
?>
            <tr class="ReportDataCenter">
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['key']->value;?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['dayNewUser'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['loginSum'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['userSum'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['UserActiveLV'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['DayPayUserSum'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['DayPayUserLV'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['PayUserSum'];?>
</td>
                <td class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['PayUserLV'];?>
</td>
            </tr>
            <?php
...
?>
        ...
        <tr class="ReportDataTitle">
            ...
            <td class="ReportDataTitle_list"><?php echo $_smarty_tpl->tpl_vars['userSumGroupSum']->value;?>
<span style="font-size: 10px;font-weight: 100">[去重]</span></td>
        </tr>
    </table>
</div>
<?php echo '<script'; ?>
    ...
    $(function(){
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(serverIndex!='' && startDay!='' && endDay!=''){
                ...
                $.get("/ActiveUsersGet/",{"serverIndex":serverIndex,"startDay":startDay,"endDay":endDay,"className":className},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
...
/*/ block_function_bbb_1176862608576ce5f6cfd457_97291167 */
?>
<?php
/* block_function_bbb_1346736862576ce5f6d4be54_32366594  file:Admin/index.html */
if (!function_exists('block_function_bbb_1346736862576ce5f6d4be54_32366594')) {
function block_function_bbb_1346736862576ce5f6d4be54_32366594($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_1346736862576ce5f6d4be54_32366594 */
?>
